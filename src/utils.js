...
export function createMatrix(R, C, defaultValue) {
  var result = [];
  for (var i = 0; i < R; i++) {
    var row = [];
...
export function BFS(r, c, board, blockedCells) {
  var R = board.length;
...
export function drawBackground(canvas, board) {
  var R = board.length,
    C = board[0].length;
